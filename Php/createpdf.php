<?php
    ...
    $pdf->Cell(40,11,$username,"0","1","C");
    $pdf->SetFont("Arial","B","18");
    $pdf->Cell(38,11,"Email : ","0","0");
    $pdf->SetFont("Arial","","16");
    $pdf->Cell(35,11,$email,"0","1","C");
    $pdf->SetFont("Arial","B","18");
    $pdf->Cell(30,11,"Wallet : ","0","0");
    $pdf->SetFont("Arial","","16");
    $pdf->Cell(15,11,$wallet,"0","1","C");
    $pdf->Ln(4);
    ...
    //mreged cell
    $pdf->SetFont("Arial","B","16");
    $pdf->Cell(198,10,"Category Wise","0","1","C");
    ...
    {   
        ...
        $pdf->setTextColor(0,0,0);
        $pdf->Cell(20,10,$i++,"1","0","C");
        $pdf->Cell(32,10,$res[3],"1","0","C");
        $pdf->Cell(23,10,$res[2],"1","0","C");
    }
    ...
    while($i<mysqli_num_rows($query2))
    {
        ...
        {
            case "Bills & Utilities":   $color=[223,32,32]; //Red 
                                        break;
            ...
            case "Family":              $color=[20,184,20]; //Green
                                        break;
            case "Fees & Charges":      $color=[117,77,179]; //Purple
                                        break;
            case "Food & Beverages":    $color=[3,3,99]; //Deep Blue
                                        break;
            case "Friends & Lover":     $color=[255,102,140]; //Pink
                                        break;
            case "Gifts & Donations":   $color=[0,153,153]; //Teal
                                        break;
            case "Health & Fitness":    $color=[255,102,0]; //Orange
                                        break;
